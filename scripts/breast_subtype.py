...
# Paths
agg_func = "delta"
input_dir = "/home/filippo.gastaldello/data/pnet_fork/pnet_gene/breast_subtype/input/aggregated_scores/"+agg_func+"/"
cancer_genes_list = "/home/filippo.gastaldello/data/pnet_fork/resources/gene_lists/CancerGenesList.csv"
tumor_subtypes_path = "/home/filippo.gastaldello/data/pnet_fork/resources/cancer_subtype.csv"
...
plt.clf()
Pnet.evaluate_interpret_save(model, test_dataset, tumor_subtypes.columns.values, "/home/filippo.gastaldello/data/pnet_fork/pnet_gene/breast_subtype/plots/breast_subtype_prediction")
