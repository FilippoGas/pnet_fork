import sys
import os
sys.path.append(os.path.dirname(__file__)+"/../scr/")
...
gene_feature_importances, additional_feature_importances, gene_importances, layer_importance_scores = Pnet.evaluate_interpret_save(model,
                                                                                                                                   ...
                                                                                                                                   "/home/filippo.gastaldello/data/pnet_fork/pnet_gene/breast_subtype/bc/"+tumor_type+"/plots/"+score_type+"/"+agg_func)
...
fig = sk.get_sankey_diag("/home/filippo.gastaldello/data/pnet_fork/pnet_gene/breast_subtype/bc/"+tumor_type+"/plots/"+score_type+"/"+agg_func+"/sankey.html")